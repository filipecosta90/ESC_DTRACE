thread{1} = readtable('__best_simulation_csv/static/sorted_DTRACE_static_1/1.csv','ReadVariableNames',true);
...
set(l,'FontSize',14 );
t = title({'Relation between OpenMP Scheduling, \#OpenMP Threads, and Total time for solution in $\mu$s','For 1 OpenMP Thread with STATIC SCHEDULING'},'interpreter','latex')
set(t,'FontSize',18);
set(gca,'YTick',[ 0 1 2 ]);
